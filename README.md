...
FaceOffAPI:
![Alt text](/ProjectImages/FaceOffAPI.png
# AnimeBattleGenerator
...
My CI Pipeline consists of a few Steps 
 ...
 2. Setup Resource group that contains AppServices and AppService plans on Azure using Terraform:
![Alt text](/ProjectImages/Terraform.PNG "Terraform")
which then shows up on azure:
![Alt text](/ProjectImages/TerraformDeployed.PNG "Terraform")
 3. Setup CI workflow using GitHub actions:
![Alt text](/ProjectImages/Workflow.PNG "Workflow")
Completed workflow:
![Alt text](/ProjectImages/GitHubActions.PNG "GitHub Actions")
